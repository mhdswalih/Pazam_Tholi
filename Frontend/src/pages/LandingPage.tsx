...
import MainImage from '../assets/img/Screenshot_2025-05-07_211736-removebg-preview.png'
      ...
      <div className="container mx-auto px-4 py-12 flex flex-col lg:flex-row justify-between items-center gap-12">
        ...
        >
          <div className={`p-8 rounded-2xl shadow-lg ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
            <h3 className={`text-2xl font-bold mb-20 text-center ${darkMode ? 'text-white' : 'text-gray-800'}`}>
              Start Connecting
            </h3>
