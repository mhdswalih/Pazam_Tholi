      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2 px-4 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-center text-sm text-gray-700 mt-6">
            ...
            <span onClick={() => navigate('/signup')} className="text-green-700 font-medium cursor-pointer hover:underline">
              Sign Up
            </span>
          </p>
        </form>
